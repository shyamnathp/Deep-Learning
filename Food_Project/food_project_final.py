...
Original file is located at
    https://colab.research.google.com/drive/16WylsRJ3dAJH4Ta4SBvGYxQu6WWg3woZ
"""
...
#     print(labels.shape)
    ...
    i=0
    print(len(list(kf.split(features))))
    for train, test in kf.split(features):
        i+=1
...
#                 if i >= 1:
                ...
                #preds = preds.cpu().clone().numpy()
                #print ("preds converted successfully")
...
for data_dir in ImageDirectory:
    ...
    del resnet34, criterion, optimizer_ft, exp_lr_scheduler, dataloaders, image_datasets
log.close()
>>>>>>> 353e816f4e29670d9aeaeffc6cd0ebd85e0c73cd
